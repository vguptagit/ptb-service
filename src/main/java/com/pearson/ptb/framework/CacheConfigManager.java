...
public final class CacheConfigManager extends BaseConfigurationManager{
	...
	protected CacheConfigManager(){
		// Calling parent class Constructor to load all properties from cache properties file
		super();
	}		
	 ...
	 * </p>
	 * 
	 * @return Cache configuration Manager returns the instance of CacheConfigManager
	 *         class.
