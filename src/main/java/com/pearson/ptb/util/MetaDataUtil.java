...
public class MetaDataUtil {
	...
	/**
	 * setting the Node specific properties in QuestionEnvelop of the PAF
	 * package
	 * 
	 * @param chapter,
	 *            Container bean
	 * @param pafQuestion,
	 *            paf question to be updated with container data
	 */
	public static void setNodeMetadata(Container chapter, Activity metadata) {
	 ...
	 *            Book bean with data
	 * @param pafQuestion,
	 *            paf questin to be updated with book data
	 */
	public static void setBookMetadata(Book book, Activity metadata) {
