...
public class URLHelper {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static Map<String, String> getQueryMap(String query,Map<String, String> keyMap) {
		...
		try {
			if (query != null) {
				...
				for (String param : params) {
					...
					String value =URLDecoder.decode(keyValue[1],Common.UTF_8_CHAR_ENCODING);
					if (keyMap != null) {
			...
			throw new InternalException("Not able to decode the querystring", e);
		} catch (Exception e) {
