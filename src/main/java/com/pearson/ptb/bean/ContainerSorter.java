...
/**
 * This <code>ContainerSorter</code> is responsible for sorting the containers by passing Comparators to a sort method,
 *  which imposes a total ordering on containers.
 * 
 */
