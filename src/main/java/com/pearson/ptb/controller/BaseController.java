...
public abstract class BaseController {
	...
	private ResponseEntity<ErrorResponse> handleException(
			BaseException exception, HttpStatus httpStatus) {
	...
	public ResponseEntity<ErrorResponse> duplicateTitleExceptionHandler(
	...
	public ResponseEntity<ErrorResponse> badDataExceptionHandler(
			BadDataException ex) {
	...
	public ResponseEntity<ErrorResponse> expectationExceptionHandler(
	...
	/**
	 * This method catches an exception of type JSON parse. Which will further
	...
	public ResponseEntity<ErrorResponse> jsonParseExceptionExceptionHandler(
			JsonParseException exception) {

		return this.handleException(new BadDataException(exception.toString()),
				HttpStatus.BAD_REQUEST);
	}

	/**
	 * This method catches an exception of type Json mapper. Which will further
	 * map to 400 (Bad Request).
	 * 
	 * @param exception
	 *            This is the Exception instance which is caught.
	...
	public ResponseEntity<ErrorResponse> jsonMappingExceptionExceptionHandler(
	...
	/**
	 * This method catches an exception for illegal argument. Which will further
	 * map to 400 (Bad Request).
	 * 
	 * @param exception
	 *            This is the Exception instance which is caught.
	...
	/**
	 * This method catches an exception for text parsing. Which will further map
	 * to 400 (Bad Request).
	 * 
	 * @param exception
	 *            This is the Exception instance which is caught.
	...
	public ResponseEntity<ErrorResponse> parseExceptionHandler(
	...
	public ResponseEntity<ErrorResponse> baseInternalExceptionHandler(
	...
	/**
	 * This method catches an exception for MongoDB not started. Which will
	 * further map to 500 (Internal server error).
	 * 
	 * @param exception
	 *            This is the Exception instance which is caught.
	...
	public ResponseEntity<ErrorResponse> configExceptionHandler(
			ConfigException ex) {
	...
	/**
	 * This method catches an exception for invalid data in @RequestBody. Which
	 * will further map to 400 (Bad Request).
	 * 
	 * @param exception
	 *            This is the Exception instance which is caught.
	 * @return responseEntity: This is the response which will be sent in case
